#ifndef SOURCE_DRIVERS_V1730_H_
#define SOURCE_DRIVERS_V1730_H_
...
#define CHANNEL_CALIBRATION             0x809C      /* R/W       ; D32 */ 
...
#define CHANNEL_DAC_CH4                 0x1498      /* For channel 4 */
...
class Module_v1730: public ModuleManager{
public:
  Module_v1730();
  virtual ~Module_v1730();
...
private:
  ...
  bool WaitChannelStatus(int expectedStatus);

private:
  //int m_nsample;
  int32_t m_v1730_handle;
  uint m_bufferSize;
